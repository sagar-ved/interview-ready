...
3. **The Greedy Logic**: To find a larger area, we MUST find a taller line. Since the width is already shrinking, moving the **taller** pointer can't possibly help.
